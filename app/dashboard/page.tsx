    ...
    <main className="min-h-screen w-full max-w-full min-w-0 overflow-x-hidden bg-slate-950 py-6 text-white sm:py-8">
      <div className="mx-auto w-full min-w-0 max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
        ...
        <section
          ...
          className="flex flex-col gap-6 md:grid md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.1fr)] md:grid-rows-[auto_minmax(0,1fr)] md:items-stretch md:gap-x-6 md:gap-y-0"
        >
          <article className="flex min-w-0 flex-col gap-3 rounded-2xl border border-white/10 bg-slate-950/60 p-4 md:contents md:gap-0 md:border-0 md:bg-transparent md:p-0">
            <div className="min-w-0 space-y-1 md:col-start-1 md:row-start-1 md:rounded-t-2xl md:border md:border-b-0 md:border-white/10 md:bg-slate-950/60 md:p-4 md:pb-3">
              ...
              <p className="text-xs leading-snug text-zinc-500">
                Calculate position size based on account balance, risk percentage, and stop loss before logging a trade.
              </p>
            </div>
            <div className="min-w-0 min-h-0 md:col-start-1 md:row-start-2 md:-mt-px md:rounded-b-2xl md:border md:border-t-0 md:border-white/10 md:bg-slate-950/60 md:p-4 md:pt-0">
              <LotSizeCalculator embedded />
            </div>
          </article>

          <article className="flex min-w-0 flex-col gap-3 rounded-2xl border border-white/10 bg-slate-950/80 p-4 md:contents md:gap-0 md:border-0 md:bg-transparent md:p-0">
            <div className="min-w-0 space-y-1 md:col-start-2 md:row-start-1 md:rounded-t-2xl md:border md:border-b-0 md:border-white/10 md:bg-slate-950/80 md:p-4 md:pb-3">
              <div className="flex items-center justify-between gap-2">
            ...
            <div className="min-w-0 min-h-0 md:col-start-2 md:row-start-2 md:-mt-px md:rounded-b-2xl md:border md:border-t-0 md:border-white/10 md:bg-slate-950/80 md:p-4 md:pt-0">
              <TradeForm />
            </div>
          </article>
        </section>
